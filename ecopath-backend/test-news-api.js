...
const mockNewsItems = [
  {
    ...
    summary:
      "Australia's Prime Minister Anthony Albanese sought to strengthen security ties with Pacific island nations...",
    label: "Critical",
    insight:
      "Pacific island nations face climate change threats. Australia's climate policy affects regional security.",
  ...
  },
  {
    ...
    label: "High Risk",
    insight:
      "Flood events are directly related to climate change. Extreme rainfall events have increased by 7-28%.",
    source: "Climate Council Australia",
