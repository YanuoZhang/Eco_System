...
\copy generation_mix_raw_text FROM :'data_dir'/Generation_NSW.csv CSV HEADER;
...
-- ========== QLD ==========
TRUNCATE generation_mix_raw_text;
\copy generation_mix_raw_text FROM :'data_dir'/Generation_QLD.csv CSV HEADER;
INSERT INTO generation_mix (state_id, dmonth, energy_type, generation_gwh)
SELECT 'QLD',
       to_date(dmonth_txt, 'DD/MM/YYYY'),
       e.energy_type,
...
-- ========== SA ==========
TRUNCATE generation_mix_raw_text;
\copy generation_mix_raw_text(dmonth_txt,state_txt,c1,c2,c3,c4,c5) FROM :'data_dir'/Generation_SA.csv CSV HEADER;
INSERT INTO generation_mix (state_id, dmonth, energy_type, generation_gwh)
SELECT 'SA',
       to_date(dmonth_txt,'DD/MM/YYYY'),
       e.energy_type,
...
-- ========== WA ==========
TRUNCATE generation_mix_raw_text;
\copy generation_mix_raw_text(dmonth_txt,state_txt,c1,c2,c3,c4,c5,c6,c7,c8) FROM :'data_dir'/Generation_WA.csv CSV HEADER;
INSERT INTO generation_mix (state_id, dmonth, energy_type, generation_gwh)
SELECT 'WA',
       to_date(dmonth_txt,'DD/MM/YYYY'),
       e.energy_type,
...
-- ========== TAS ==========
TRUNCATE generation_mix_raw_text;
\copy generation_mix_raw_text(dmonth_txt,state_txt,c1,c2,c3,c4) FROM :'data_dir'/Generation_TAS.csv CSV HEADER;
INSERT INTO generation_mix (state_id, dmonth, energy_type, generation_gwh)
SELECT 'TAS',
       to_date(dmonth_txt,'DD/MM/YYYY'),
       e.energy_type,
...
-- ========== VIC ==========
TRUNCATE generation_mix_raw_text;
\copy generation_mix_raw_text(dmonth_txt,state_txt,c1,c2,c3,c4,c5,c6) FROM :'data_dir'/Generation_VIC.csv CSV HEADER;
INSERT INTO generation_mix (state_id, dmonth, energy_type, generation_gwh)
SELECT 'VIC',
       to_date(dmonth_txt,'DD/MM/YYYY'),
       e.energy_type,
