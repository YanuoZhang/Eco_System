...
test.describe('Back to Homepage E2E Tests', () => {
  ...
  test('TC-1.8.2: Journey Welcome loads correctly after returning from Data Insight', async ({ page }) => {
  ...
  test('TC-1.8.3: Navigation state is properly reset after returning to homepage', async ({ page }) => {
