  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto text-center">
        ...
        {/* Journey Preview */}
        <div className="mb-12 sm:mb-16">
          <h3 className="text-xl sm:text-2xl font-semibold text-green-800 mb-6 sm:mb-8 px-2">
            Your Journey Path Preview
          </h3>
          ...
          <div className="relative max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4 lg:gap-6 relative z-10 px-2">
              {[
                ...
                <div
                  key={index}
                  className={`relative bg-gradient-to-br ${step.bg} rounded-xl sm:rounded-2xl p-3 sm:p-4 lg:p-6 border-2 border-${step.color}-200 shadow-lg transform hover:scale-105 transition-all duration-300`}
                >
                  ...
                  <div className="text-center">
                    <div className="text-2xl sm:text-3xl lg:text-4xl mb-1 sm:mb-2 lg:mb-3">
                      {step.icon}
                    </div>
                    <h4 className={`font-bold text-${step.color}-800 text-xs sm:text-sm mb-1`}>
                      {step.title}
                    </h4>
                    <p className={`text-xs text-${step.color}-700 opacity-80`}>
                      {step.description}
                    </p>
                  </div>
                  ...
                  {/* Step Number Badge */}
                  <div
                    className={`absolute -top-1 -left-1 sm:-top-2 sm:-left-2 w-5 h-5 sm:w-6 sm:h-6 bg-${step.color}-500 text-white rounded-full flex items-center justify-center text-xs font-bold shadow-md`}
                  >
                    {step.number}
                  </div>
                </div>
