...
describe("RangeSelector", () => {
  ...
  describe("TC-1.5.3: Range Selection", () => {
    ...
    it("highlights selected range in dropdown", async () => {
      ...
      const selectedOption = dropdownOptions.find(btn => 
        btn.textContent === "10 Years" && btn !== button
      );
  ...
  describe("TC-1.5.5: Styling and Visual Feedback", () => {
    ...
    it("displays dropdown with proper styling", async () => {
      ...
      expect(dropdown).toHaveClass("absolute", "z-10", "w-full", "mt-1", "bg-white", "border", "border-gray-300", "rounded-md", "shadow-lg");
    });
    ...
    it("highlights hovered options", async () => {
      ...
      expect(fiveYearOption).toHaveClass("hover:bg-green-50", "hover:text-green-900", "transition-colors");
    });
  });
  ...
  describe("TC-1.5.6: Edge Cases", () => {
    ...
    it("handles very long range labels", () => {
      ...
      expect(screen.getByText("This is a very long range label that might overflow the container")).toBeInTheDocument();
    });
  ...
  describe("TC-1.5.7: Integration and State Management", () => {
    ...
    it("calls onRangeChange with correct values for all options", async () => {
      ...
      const dropdownOption = dropdownOptions.find(option => 
        option.closest('button') && option.closest('button') !== button
      );
      if (dropdownOption) {
