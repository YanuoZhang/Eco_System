...
describe('DataSources', () => {
  ...
  describe('TC-1.7.2: Open dataset list modal/panel', () => {
    it('opens modal when Data Sources button is clicked', () => {
      ...
      expect(screen.getByText('All data sources are official government and research institutions')).toBeInTheDocument();
    });
  ...
  describe('Visual Elements and Styling', () => {
    it('has proper modal header styling', () => {
      ...
      const header = screen.getByText('Official datasets used in our analysis').closest('div[class*="bg-gradient-to-r"]');
    ...
    it('displays dataset cards with proper styling', () => {
      ...
      const datasetCard = screen.getByText('ABS Census Data').closest('div[class*="border border-gray-200"]');
  ...
  describe('Accessibility and UX', () => {
    ...
    it('displays helpful footer information', () => {
      ...
      expect(screen.getByText('All data sources are official government and research institutions')).toBeInTheDocument();
      expect(screen.getByText('Click any dataset to verify the original source')).toBeInTheDocument();
    });
