    ...
    <section className="py-16 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div
          ...
          style={{
            background: "linear-gradient(180deg, rgba(59,106,122,0.4) 0%, rgba(59,106,122,0) 100%)",
          }}
        />
        <div
          className="absolute bottom-0 left-0 right-0 h-24"
          style={{
            background: "linear-gradient(0deg, rgba(59,106,122,0.4) 0%, rgba(59,106,122,0) 100%)",
          }}
        />
        ...
        <div className="bg-slate-700/50 backdrop-blur-md rounded-2xl p-8 lg:p-12 border border-slate-500/30 shadow-2xl/20">
          <div className="mb-6">
            ...
            <p className="text-base md:text-lg lg:text-xl text-slate-100 leading-relaxed mb-4">
              You&apos;ve seen the global story unfold. You&apos;ve witnessed the impacts happening
              around you. The data is clear, the science is certain, the impacts are here.
            </p>
            <p className="text-lg md:text-xl lg:text-2xl text-white font-semibold mb-6">
              But what is <em>your</em> role in this story?
            </p>
            <div className="bg-blue-600/30 backdrop-blur-sm rounded-xl p-4 md:p-6 mb-6 border border-blue-400/40">
              <p className="text-sm md:text-base lg:text-lg text-blue-100 leading-relaxed">
                Every choice you make - from the energy that powers your home to the food on your
                plate, from how you travel to what you buy - contributes to the story we&apos;re
                collectively writing. Understanding your personal environmental impact isn&apos;t
                about guilt; it&apos;s about power.
              </p>
            </div>
            <p className="text-base md:text-lg text-slate-200 mb-8">
              The power to change course. The power to be part of the solution. The power to ensure
              the next chapter is one of hope and action.
            </p>
            <a
              href="/quiz"
